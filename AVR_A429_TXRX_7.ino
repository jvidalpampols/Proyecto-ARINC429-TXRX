...
void setup(void)
{
  ...
  //pinMode(BD429_RELAY, OUTPUT); // DI09 >> PH6, OUTPUT for RELAY 4066 to connect 470pF parallel with 75 pF for LOW Speed
  DDRH |= (1 << PH6);  // OUTPUT;
  ...
  //Control_Word = (PAREN | NOT_SLFTST | PAR_ODD | TX_LO | RX_LO | WORD_32); // Enables Wrap Around Selftest "SLFTST"
  //Control_Word = (PAREN | NOT_SLFTST | PAR_ODD | TX_HI | RX_HI | WORD_32); // Enables Wrap Around Selftest "SLFTST"
  ...
  /////////////// SETUP: 1 Mhz DEI1016 Clock and 50msec Timer for A429 label refresh period //////////////////////////////////
