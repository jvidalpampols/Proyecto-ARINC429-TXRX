...
//PCF8574
#define lcd_addr 0x27     // PCF8574 I2C address of typical I2C LCD Backpack. Para PCF8574A >> 0x3F
//#define lcd_addr 0x3F     // PCF8574 I2C address of typical I2C LCD Backpack. Para PCF8574A >> 0x3F

#define keypad_addr 0x24  // I2C address of I2C Expander module (A0-A1-A2 dip switch to off position). Para PCF8574A >> 0X3C 
//#define keypad_addr 0x3C  // I2C address of I2C Expander module (A0-A1-A2 dip switch to off position). Para PCF8574A >> 0X3C
